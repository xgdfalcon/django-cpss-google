...
from .models.client import GoogleClientOption, GoogleCalendar, GoogleEvent

@admin.register(GoogleClientOption)
class GoogleClientAdmin(admin.ModelAdmin):
    list_display = ('google_client_id', 'site')
    list_filter = ('site',)
    list_select_related = True
    readonly_fields = ('google_access_token','google_refresh_token')
...
class GoogleCalendarAdmin(admin.ModelAdmin):
    list_display = ('google_calendar_id', 'site')
    list_filter = ('site',)
    list_select_related = True
...
class GoogleEventAdmin(admin.ModelAdmin):
    list_display = ('start', 'summary', 'location')
    list_filter = ('start', 'summary', 'location')
    list_select_related = True
